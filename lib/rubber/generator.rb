      ...
      def transform(src_data, options={})
        ...
        if orig != result || force
          ...
          if config_path
            ...
            system("dos2unix #{config_path} || true") # TODO: run dos2unix only if running Windows locally (how?)
          ...
          # Handle write_cmd by dumping the body to a file and then piping that into the command.
            ...
            begin
              file.write(result)
              file.close
              system("dos2unix #{file.path} || true") # TODO: run dos2unix only if running Windows locally (how?)
