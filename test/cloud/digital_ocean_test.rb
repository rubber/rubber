  ...
  context 'digital_ocean' do
    ...
    context '#create_instance' do
      should 'create instance' do
        assert @cloud.create_instance('my-instance', 'Ubuntu 12.04.3 x64', '512MB', [], '', 'New York 1')
      end

      should 'raise error if invalid region' do
        begin
          @cloud.create_instance('my-instance', 'Ubuntu 12.04.3 x64', '512MB', [], '', 'Mars 1')
        rescue => e
      ...
      should 'raise an error if invalid image type' do
        begin
          @cloud.create_instance('my-instance', 'Ubuntu 12.04.3 x64', 'm1.small', [], '', 'New York 1')
        rescue => e
      ...
      should 'raise an error if no remote SSH key and local key_file is bad' do
        begin
          ...
          cloud.create_instance('my-instance', 'Ubuntu 12.04.3 x64', '512MB', [], '', 'New York 1')
        rescue => e
